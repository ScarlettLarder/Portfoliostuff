...
function Rive_robot() {
  ...
  return (
    ...
    <div className="sm:float-right sm:mr-20 pt-10 h-72 pb-34 sm:h-96 w-full sm:w-2/5 drop-shadow-xl delay-75 hover:scale-105 duration-150">
      <RiveComponent />
    </div>
  );
}
    ...
    <div>
      ...
      <div className="mt-32 gradient clearfix shadow-md border-blue-200 border-t-4 border-b-4">
          <div className='xl:bg-[url("/Personal_DecoRM.svg")] bg-none sm:bg-no-repeat bg-right bg-contain overflow-visible'>
            ...
            <Image className='sm:mt-3 sm:ml-24 sm:float-none px-10 mx-auto text-center sm:text-left bg-opacity-0 sm:bg-opacity-100' src="Personal_DecoLine.svg" alt="dash2" width={450} height={0}/>
            <p className="text-2xl sm:text-4xl mx-4 sm:mx-16 pb-px text-gray-600 font-bold mt-4 whitespace-normal text-center sm:text-left"> Hello! I am Scarlett and welcome to my portfolio.</p>
            <Rive_robot />
            <p className="text-2xl sm:text-3xl mt-4 sm:mt-0 sm:ml-16 text-gray-600 font-normal whitespace-normal text-center sm:text-left"> Im Currently in college, learning web and design. In this website, you will find out more about me, who I am and a selection of projects.</p>
      ...
      <Image className='flex float-right ' src="Edu_DecoBL.svg" alt="dash2" width={400} height={400}/>
      ...
      <p className="text-2xl sm:text-3xl mt-4 m-8 sm:m-0 sm:ml-16 text-gray-600 font-normal whitespace-normal text-center sm:text-left"> 
      ...
      <p className="text-3xl sm:text-4xl sm:ml-16 m-4 text-gray-600 font-bold whitespace-normal text-center sm:text-left"> Some of my skills include:</p>
      <Image className='right-0 float-right sm:mr-24 mx-auto hover:scale-105 duration-150 delay-75' src="Edu_PopupStrode.svg" alt="dash2" width={700} height={500}/>
      <p className="text-2xl sm:text-3xl sm:ml-16 text-gray-600 font-normal whitespace-normal text-center sm:text-left mt-6 sm:mt-0"> Video editing, web development, and experience with design, <br/> Rive and Figma.</p>
      <Image className='sm:right-0 sm:float-right sm:mr-12 sm:mt-12 mt-6 mx-auto hover:scale-105 duration-150 delay-75' src="Edu_PopupSoftware.svg" alt="dash2" width={220} height={500}/>
      <Image className='mt-10' src="Edu_DecoTL.svg" alt="dash2" width={700} height={500}/>
      ...
      <div className="mt-24 pt-10 clearfix gradient2 border-t-4 border-b-4 border-green-200 shadow-md">
        <div className="sm:bg-[url('/Hobbyliny.svg')] bg-none sm:bg-no-repeat bg-right bg-contain ">
            ...
            <Image className=' sm:ml-10 sm:pb-10 sm:float-none px-10 mx-auto' src="Hobby_DecoLine.svg" alt="dash2" width={420} height={500}/>
            <Image className="float-right mt-3 sm:mr-20 pb-10 hover:scale-105 duration-150 delay-75 " src="Hobby_PopupYT.svg" alt="dash2" width={800} height={500}/>
            ...
            <div className="sm:ml-96 mt-16 pb-10 ">
                <div className="h-96 sm:h-96 sm:w-2/5 w-full hover:scale-105 duration-150 delay-75">
                    <RiveComponent />
                </div>
            </div>
        </div>
      ...
      <div className="bg-[url('/Contact_DecoML.svg')] bg-no-repeat bg-bottom sm:bg-left  bg-contain">
          <h1 className="text-6xl xl:text-8xl mx-16 pb-px mt-40 text-gray-700 lmao font-bold bg-local"> Contact </h1>
          <Image className='flex sm:mx-16 pb-px' src="Contact_DecoLine.svg" alt="dash2" width={340} height={100}/>
          <p className="mt-10 text-2xl sm:text-3xl mx-4 sm:mx-16 pb-px text-gray-600 font-normal whitespace-normal text-left"> You can find me on <a className="text-red-300 hover:text-red-200 underline" href="https://www.linkedin.com/in/alex-larder-066692258/">LinkedIn</a></p>
          <div className="">
