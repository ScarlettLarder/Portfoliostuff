...
export default function Home() {
  ...
  return (
    <div>
      ...
      <Image className='flex mx-auto sm:mx-16 ' src="backtedu.svg" alt="dash2" width={420} height={500}/>
      ...
      <Image className='sm:right-0 sm:float-right sm:mr-12 sm:mt-12 mt-6 mx-auto popupimg' src="Pop-up 4.svg" alt="dash2" width={220} height={500}/>
