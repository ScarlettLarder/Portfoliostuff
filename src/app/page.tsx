...
export default function Home() {
  ...
  return (
    <main>
      ...
      <div className="mt-32 pt-10 gradient clearfix shadow-md  border-blue-00 border-t-4 border-b-4">
      ...
      <div className="mt-24 pt-10 clearfix gradient2 border-t-4 border-b-4 border-green-200 shadow-md">
        <div className="sm:bg-[url('/Hobbyliny.svg')] bg-none sm:bg-no-repeat bg-bottom bg-right bg-contain ">
              <h1 className="text-6xl xl:text-8xl text-center sm:text-left  mx-16 pb-px text-gray-700 lmao font-bold"> Hobbiesda </h1>
